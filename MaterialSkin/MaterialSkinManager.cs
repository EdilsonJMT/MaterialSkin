namespace MaterialSkin
{
    ...
    public class MaterialSkinManager
    {
        ...
        private MaterialSkinManager()
        {
            ...
            addFontRtl(Resources.IRANYekan_Thin);
            addFontRtl(Resources.IRANYekan_Light);
            addFontRtl(Resources.IRANYekan_Regular);
            addFontRtl(Resources.IRANYekan_Medium);
            addFontRtl(Resources.IRANYekan_Bold);
            addFontRtl(Resources.IRANYekan_Black);
            ...
            foreach (FontFamily ff in privateFontCollectionRtl.Families.ToArray())
            {
                if (RobotoFontFamilies.Any(i => i.Key == ff.Name)) continue;
                RobotoFontFamilies.Add(ff.Name.Replace(' ', '_'), ff);
            }
            ...
            logicalFonts.Add("H1_RTL", createLogicalFont("IRANYekanMobileFN Light", 96, NativeTextRenderer.logFontWeight.FW_LIGHT));
            logicalFonts.Add("H2_RTL", createLogicalFont("IRANYekanMobileFN Light", 60, NativeTextRenderer.logFontWeight.FW_LIGHT));
            logicalFonts.Add("H3_RTL", createLogicalFont("IRANYekanMobileFN", 48, NativeTextRenderer.logFontWeight.FW_REGULAR));
            logicalFonts.Add("H4_RTL", createLogicalFont("IRANYekanMobileFN", 34, NativeTextRenderer.logFontWeight.FW_REGULAR));
            logicalFonts.Add("H5_RTL", createLogicalFont("IRANYekanMobileFN", 24, NativeTextRenderer.logFontWeight.FW_REGULAR));
            logicalFonts.Add("H6_RTL", createLogicalFont("IRANYekanMobileFN Medium", 20, NativeTextRenderer.logFontWeight.FW_MEDIUM));
            logicalFonts.Add("Subtitle1_RTL", createLogicalFont("IRANYekanMobileFN", 16, NativeTextRenderer.logFontWeight.FW_REGULAR));
            logicalFonts.Add("Subtitle2_RTL", createLogicalFont("IRANYekanMobileFN Medium", 14, NativeTextRenderer.logFontWeight.FW_MEDIUM));
            logicalFonts.Add("SubtleEmphasis_RTL", createLogicalFont("IRANYekanMobileFN", 12, NativeTextRenderer.logFontWeight.FW_NORMAL, 1));
            logicalFonts.Add("Body1_RTL", createLogicalFont("IRANYekanMobileFN", 16, NativeTextRenderer.logFontWeight.FW_REGULAR));
            logicalFonts.Add("Body2_RTL", createLogicalFont("IRANYekanMobileFN", 14, NativeTextRenderer.logFontWeight.FW_REGULAR));
            logicalFonts.Add("Button_RTL", createLogicalFont("IRANYekanMobileFN Medium", 14, NativeTextRenderer.logFontWeight.FW_MEDIUM));
            logicalFonts.Add("Caption_RTL", createLogicalFont("IRANYekanMobileFN", 12, NativeTextRenderer.logFontWeight.FW_REGULAR));
            logicalFonts.Add("Overline_RTL", createLogicalFont("IRANYekanMobileFN", 10, NativeTextRenderer.logFontWeight.FW_REGULAR));
            ...
            logicalFonts.Add("textBox16_RTL", createLogicalFont("IRANYekanMobileFN", 16, NativeTextRenderer.logFontWeight.FW_REGULAR));
            logicalFonts.Add("textBox15_RTL", createLogicalFont("IRANYekanMobileFN", 15, NativeTextRenderer.logFontWeight.FW_REGULAR));
            logicalFonts.Add("textBox14_RTL", createLogicalFont("IRANYekanMobileFN", 14, NativeTextRenderer.logFontWeight.FW_REGULAR));
            logicalFonts.Add("textBox13_RTL", createLogicalFont("IRANYekanMobileFN Medium", 13, NativeTextRenderer.logFontWeight.FW_MEDIUM));
            logicalFonts.Add("textBox12_RTL", createLogicalFont("IRANYekanMobileFN Medium", 12, NativeTextRenderer.logFontWeight.FW_MEDIUM));
        }
        ...
        /// <returns></returns>
        public IntPtr getTextBoxFontBySize(int size,RightToLeft RightToLeft= RightToLeft.No)
        {
            var rtl = (RightToLeft==RightToLeft.Yes) ? "_RTL" : "";
            string name = "textBox" + Math.Min(16, Math.Max(12, size)).ToString() + rtl;
        ...
        private PrivateFontCollection privateFontCollectionRtl = new PrivateFontCollection();
        ...
        private void addFontRtl(byte[] fontdata)
        {
            ...
            // GDI+ Font
            privateFontCollectionRtl.AddMemoryFont(ptrFont, dataLength);
        }
        ...
        private void UpdateControlBackColor(Control controlToUpdate, Color newBackColor)
        {
            ...
            else if (EnforceBackcolorOnAllComponents && controlToUpdate.HasProperty("BackColor") && !controlToUpdate.IsMaterialControl() && controlToUpdate.Parent != null)
            {
                ...
                controlToUpdate.ForeColor = TextHighEmphasisColor;
                controlToUpdate.Font = getFontByType(MaterialSkinManager.fontType.Body1, RightToLeft);
            }
