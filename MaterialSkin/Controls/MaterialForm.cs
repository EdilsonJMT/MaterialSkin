namespace MaterialSkin.Controls
{
    ...
    public class MaterialForm : Form, IMaterialControl
    {
        ...
        private MaterialDrawer drawerControl;
        ...
        public MaterialForm(RightToLeft rightToLeft)
        {
            ...
            InitializeComponent();
            drawerControl = new MaterialDrawer(RightToLeft);
            DrawerWidth = 200;
            DrawerIsOpen = false;
        ...
        protected void AddDrawerOverlayForm()
        {
            ...
            drawerOverlay.RightToLeft = RightToLeft;
            ...
            drawerForm.Location = new Point(locationX, locationY);
            ...
            drawerForm.RightToLeft = RightToLeft;
            ...
            Move += (sender, e) =>
            {
                locationY = Location.Y + _statusBarBounds.Height + _actionBarBounds.Height;
                locationX = RightToLeft == RightToLeft.Yes ? Location.X + (Width - DrawerWidth) : Location.X;
                drawerForm.Location = new Point(locationX, locationY); 
                drawerOverlay.Location = new Point(Location.X, locationY);                
            };
        ...
        private void RecalculateFormBoundaries()
        {
            ...
            if (DrawerTabControl != null)
            {
                int locationY = Location.Y + STATUS_BAR_HEIGHT + ACTION_BAR_HEIGHT;
                int locationX = RightToLeft == RightToLeft.Yes ? Location.X + (Width - DrawerWidth) : Location.X;
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            if (ControlBox == true && _formStyle != FormStyles.ActionBar_None && _formStyle != FormStyles.StatusAndActionBar_None)
            {
                ...
                using (NativeTextRenderer NativeText = new NativeTextRenderer(g))
                {
                    ...
                    NativeText.DrawTransparentText(Text, SkinManager.getLogFontByType(MaterialSkinManager.fontType.H6, RightToLeft),
