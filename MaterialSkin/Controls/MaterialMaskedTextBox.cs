namespace MaterialSkin.Controls
{
    ...
    public class MaterialMaskedTextBox : Control, IMaterialControl
    {
        ...
        public MaterialMaskedTextBox():this(RightToLeft.No)
        {
        }
        public MaterialMaskedTextBox(RightToLeft RightToLeft)
        {
            // Material Properties
            UseAccent = true;
            ...
            Font = SkinManager.getFontByType(MaterialSkinManager.fontType.Subtitle1, RightToLeft);
        ...
        private void UpdateRects()
        {
            ...
            if (_prefixsuffix == PrefixSuffixTypes.Prefix && _prefixsuffixText != null && _prefixsuffixText.Length > 0)
            {
                ...
                {
                    _prefix_padding = NativeText.MeasureLogString(_prefixsuffixText, SkinManager.getLogFontByType(MaterialSkinManager.fontType.Subtitle1, RightToLeft)).Width + PREFIX_SUFFIX_PADDING;
                    _left_padding += _prefix_padding;
                }
            }
            else
            ...
            if (_prefixsuffix == PrefixSuffixTypes.Suffix && _prefixsuffixText != null && _prefixsuffixText.Length > 0)
            {
                using (NativeTextRenderer NativeText = new NativeTextRenderer(CreateGraphics()))
                {
                    _suffix_padding = NativeText.MeasureLogString(_prefixsuffixText, SkinManager.getLogFontByType(MaterialSkinManager.fontType.Subtitle1, RightToLeft)).Width + PREFIX_SUFFIX_PADDING;
