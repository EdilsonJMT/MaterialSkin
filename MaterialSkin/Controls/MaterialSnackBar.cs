namespace MaterialSkin.Controls
{
    ...
    public class MaterialSnackBar : MaterialForm
    {
        ...
        /// </summary>
        public MaterialSnackBar(string Text, int Duration, bool ShowActionButton, string ActionButtonText, bool UseAccentColor, RightToLeft rightToLeft = RightToLeft.No) : base(rightToLeft)
        {
            this.Text = Text;
        ...
        public MaterialSnackBar(RightToLeft rightToLeft=RightToLeft.No) : this("SnackBar Text", 3000, false, "OK", false, rightToLeft)
        {
        }

        public MaterialSnackBar(string Text, RightToLeft rightToLeft = RightToLeft.No) : this(Text, 3000, false, "OK", false, rightToLeft)
        {
        }

        public MaterialSnackBar(string Text, int Duration, RightToLeft rightToLeft = RightToLeft.No) : this(Text, Duration, false, "OK", false, rightToLeft)
        {
        }

        public MaterialSnackBar(string Text, string ActionButtonText, RightToLeft rightToLeft = RightToLeft.No) : this(Text, 3000, true, ActionButtonText, false, rightToLeft)
        {
        }

        public MaterialSnackBar(string Text, string ActionButtonText, bool UseAccentColor, RightToLeft rightToLeft = RightToLeft.No) : this(Text, 3000, true, ActionButtonText, UseAccentColor, rightToLeft)
        {
        }

        public MaterialSnackBar(string Text, int Duration, string ActionButtonText, RightToLeft rightToLeft = RightToLeft.No) : this(Text, Duration, true, ActionButtonText, false, rightToLeft)
        {
        }

        public MaterialSnackBar(string Text, int Duration, string ActionButtonText, bool UseAccentColor, RightToLeft rightToLeft) : this(Text, Duration, true, ActionButtonText, UseAccentColor, rightToLeft)
        {
        }
        ...
        private void UpdateRects()
        {
            ...
            {
                int _buttonWidth = ((TextRenderer.MeasureText(ActionButtonText, SkinManager.getFontByType(MaterialSkinManager.fontType.Button, RightToLeft))).Width + 32);
            ...
            Width = TextRenderer.MeasureText(_text, SkinManager.getFontByType(MaterialSkinManager.fontType.Body2, RightToLeft)).Width + (2 * LEFT_RIGHT_PADDING) + _actionButton.Width + 48;
            Region = System.Drawing.Region.FromHrgn(CreateRoundRectRgn(0, 0, Width, Height, 6, 6));
