namespace MaterialSkin.Controls
{
    ...
    public class MaterialDialog : MaterialForm
    {
        ...
        public MaterialDialog(
            Form ParentForm, string Title, 
            string Text, string ValidationButtonText, 
            bool ShowCancelButton, 
            string CancelButtonText, 
            bool UseAccentColor, 
            RightToLeft rightToLeft = RightToLeft.No) :base(rightToLeft)
        {
            ...
            Width = 560;
            int TextWidth = TextRenderer.MeasureText(_text, SkinManager.getFontByType(MaterialSkinManager.fontType.Body1, RightToLeft)).Width;
            ...
            int _buttonWidth = ((TextRenderer.MeasureText(ValidationButtonText, SkinManager.getFontByType(MaterialSkinManager.fontType.Button, RightToLeft))).Width + 32);
            ...
            _buttonWidth = ((TextRenderer.MeasureText(CancelButtonText, SkinManager.getFontByType(MaterialSkinManager.fontType.Button, RightToLeft))).Width + 32);
        ...
        public MaterialDialog(Form ParentForm,RightToLeft rightToLeft = RightToLeft.No) : this(ParentForm, "Title", "Dialog box", "OK", false, "Cancel", false, rightToLeft)
        {
        }

        public MaterialDialog(Form ParentForm, string Text, RightToLeft rightToLeft = RightToLeft.No) : this(ParentForm, "Title", Text, "OK", false, "Cancel", false, rightToLeft)
        {
        }

        public MaterialDialog(Form ParentForm, string Title, string Text, RightToLeft rightToLeft = RightToLeft.No) : this(ParentForm, Title, Text, "OK", false, "Cancel", false, rightToLeft)
        {
        }

        public MaterialDialog(Form ParentForm, string Title, string Text, string ValidationButtonText, RightToLeft rightToLeft = RightToLeft.No) : this(ParentForm, Title, Text, ValidationButtonText, false, "Cancel", false, rightToLeft)
        {
        }

        public MaterialDialog(Form ParentForm, string Title, string Text, bool ShowCancelButton, RightToLeft rightToLeft = RightToLeft.No) : this(ParentForm, Title, Text, "OK", ShowCancelButton, "Cancel", false, rightToLeft)
        {
        }

        public MaterialDialog(Form ParentForm, string Title, string Text, bool ShowCancelButton, string CancelButtonText, RightToLeft rightToLeft = RightToLeft.No) : this(ParentForm, Title, Text, "OK", ShowCancelButton, CancelButtonText, false, rightToLeft)
        {
        }

       public MaterialDialog(Form ParentForm, string Title, string Text, string ValidationButtonText, bool ShowCancelButton, string CancelButtonText, RightToLeft rightToLeft = RightToLeft.No) : this(ParentForm, Title, Text, ValidationButtonText, ShowCancelButton, CancelButtonText, false, rightToLeft)
        {
        }
        ...
        protected override void OnPaint(System.Windows.Forms.PaintEventArgs e)
        {
            ...
            using (NativeTextRenderer NativeText = new NativeTextRenderer(g))
            {
                ...
                NativeText.DrawTransparentText(
                    _title,
                    SkinManager.getLogFontByType(MaterialSkinManager.fontType.H6, RightToLeft),
