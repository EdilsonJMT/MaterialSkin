...
namespace MaterialSkin.Controls
{
    ...
    public class MaterialListBox : Control, IMaterialControl
    {
        ...
        public MaterialListBox()
        {
            ...
            base.Font = SkinManager.getFontByType(MaterialSkinManager.fontType.Subtitle1, RightToLeft);
            _secondaryFont = SkinManager.getFontByType(MaterialSkinManager.fontType.Body1, RightToLeft);
            SetDefaults();
            ShowBorder = true;
            ShowScrollBar = false;
            MultiSelect = false;
        ...
        private void UpdateItemSpecs()
        {
            if (_style == ListBoxStyle.TwoLine)
            {
                ...
                if (_density == MaterialItemDensity.Dense)
                {
                    ...
                    _primaryFont = SkinManager.getFontByType(MaterialSkinManager.fontType.Body1, RightToLeft);
                    _secondaryFont = SkinManager.getFontByType(MaterialSkinManager.fontType.Body2, RightToLeft);
                }
                else
                {
                    _itemHeight = 72;
                    ...
                    _primaryFont = SkinManager.getFontByType(MaterialSkinManager.fontType.Subtitle1, RightToLeft);
                    _secondaryFont = SkinManager.getFontByType(MaterialSkinManager.fontType.Body1, RightToLeft);
                }
            }
