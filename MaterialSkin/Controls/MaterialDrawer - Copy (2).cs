        ...
        private void preProcessIcons()
        {
            ...
            foreach (TabPage tabPage in _baseTabControl.TabPages)
            {
                ...
                Rectangle iconRect = new Rectangle(
                   ...
                   _baseTabControl.ImageList.Images[tabPage.ImageKey].Width + 18 , _baseTabControl.ImageList.Images[tabPage.ImageKey].Height);
            ...
            foreach (TabPage tabPage in _baseTabControl.TabPages)
            {
                ...
                if (_baseTabControl.ImageList != null && !String.IsNullOrEmpty(tabPage.ImageKey))
                {
                    ...
                    Rectangle iconRect = new Rectangle(
                        ...
                        iconsSize[tabPage.ImageKey].Width + 18, iconsSize[tabPage.ImageKey].Height);
