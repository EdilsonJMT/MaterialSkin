    ...
    public class MaterialTextBox : RichTextBox, IMaterialControl
    {
        ...
        protected override void OnPaint(PaintEventArgs pevent)
        {
            ...
            using (NativeTextRenderer NativeText = new NativeTextRenderer(g))
            {
                ...
                int selectX = NativeText.MeasureLogString(textBeforeSelection, SkinManager.getLogFontByType(MaterialSkinManager.fontType.Subtitle1, RightToLeft)).Width;
                int selectWidth = NativeText.MeasureLogString(textSelected, SkinManager.getLogFontByType(MaterialSkinManager.fontType.Subtitle1, RightToLeft)).Width;
